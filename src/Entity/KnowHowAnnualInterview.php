...
/**
 * @ORM\Entity(repositoryClass="App\Repository\KnowHowRepository")
 * @ORM\Table(name="know_how_annual_interview")
 */
class KnowHowAnnualInterview
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\AnnualInterview", inversedBy="knowHows")
